...
public partial class EditarVisualizarAlimentacaoDiariaView : ContentPage
{
    ...
    public EditarVisualizarAlimentacaoDiariaView()
	{
		InitializeComponent();
        BindingContext = new EditarVisualizarAlimentacaoDiariaViewModel();
        //CarregarTipos();
    }

    public EditarVisualizarAlimentacaoDiariaView(LancarRefeicoes refeicoes)
    {
        InitializeComponent();
        BindingContext = new EditarVisualizarAlimentacaoDiariaViewModel(refeicoes);
        //CarregarTipos();
